 ...
 */
#define TEMP_SENSOR_0 21 // Pt100 with circuit in the Ultimainboard V2.x with 3.3v excitation (STM32 \ LPC176x....)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 400 } // in future check titan aero Steps Per Unit 415 or 400. My prev setting = 415
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 60, 25, -1 }
